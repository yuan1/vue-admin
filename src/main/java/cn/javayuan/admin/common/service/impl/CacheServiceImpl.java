package cn.javayuan.admin.common.service.impl;
...
import cn.javayuan.admin.system.domain.Menu;
...
import cn.javayuan.admin.system.service.MenuService;
import cn.javayuan.admin.system.service.RoleService;
...
public class CacheServiceImpl implements CacheService {
    ...
    public UserConfig getUserConfig(String userId) throws Exception {
        String userConfigString = this.redisService.get(AdminConstant.USER_CONFIG_CACHE_PREFIX + userId);
    ...
    public void saveUser(User user) throws Exception {
        ...
        redisService.set(AdminConstant.USER_CACHE_PREFIX + username, mapper.writeValueAsString(user));
    }
    ...
    public void saveRoles(String username) throws Exception {
        ...
        if (!roleList.isEmpty()) {
            ...
            redisService.set(AdminConstant.USER_ROLE_CACHE_PREFIX + username, mapper.writeValueAsString(roleList));
        }
    ...
    public void savePermissions(String username) throws Exception {
        ...
        if (!permissionList.isEmpty()) {
            ...
            redisService.set(AdminConstant.USER_PERMISSION_CACHE_PREFIX + username, mapper.writeValueAsString(permissionList));
        }
    }
    ...
    public void saveUserConfigs(String userId) throws Exception {
        ...
        if (userConfig != null) {
            ...
            redisService.set(AdminConstant.USER_CONFIG_CACHE_PREFIX + userId, mapper.writeValueAsString(userConfig));
        }
    }
    ...
    public void deleteUserConfigs(String userId) throws Exception {
        redisService.del(AdminConstant.USER_CONFIG_CACHE_PREFIX + userId);
    }
}
