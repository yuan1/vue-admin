...
import cn.javayuan.admin.system.service.RoleMenuServie;
...
public class RoleController extends BaseController {
    ...
    public void deleteRoles(@NotBlank(message = "{required}") @PathVariable String roleIds) throws AdminException {
        try {
